...
TRANSLATIONS = {
    ...
    "اردو (Urdu)": {
        ...
        "btn_back": "⬅️ پیچھے",
        "btn_next": "جاری رکھیں ➔",
        حاصل_کردہ: "آپ کا زیادہ سے زیادہ کھاد کا بجٹ (₹)",
    ...
    "ಕನ್ನಡ (Kannada)": {
        "title": "ಸ್ಮಾರ್ಟ್ కిసాನ್ | ಅಗ్రిಟೆಕ್ ಕಂಟ್ರೋಲ್ ಸೆಂಟರ್",
    ...
    "ਪੰਜਾਬੀ (Punjabi)": {
        ...
        "mode_diag": "🔬 ਸਿਰਫ਼ ਪੌਦਿਆਂ ਦੀ ਬیمਾਰੀ ਅਤੇ ਦਵਾਈ ਨਿਦਾਨ",
        ...
        "soil_detected": "ਮਿੱਟੀ ਦਾ ਪਤਾ ਲੱगਿਆ ਹੈ",
    ...
    "தமிழ் (Tamil)": {
        ...
        "mode_opt": "🌾 முழுமையான மண் மற்றும் உர உகப்பாக்க管道",
