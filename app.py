...
TRANSLATIONS = {
    ...
    "মণিপুরী (Manipuri)": {
        "title": "স্মার্ট কিসান | এগ্রিতেক কন্ত্রোল সেন্তর",
        "subtitle": "চুমথোকপা 4R শিংনবা নুট্রিয়েন্ত অমসুং অফিসিয়েল প্রেসক্রিপশন",
        "login_tab": "সাইন ইন",
        "reg_tab": "রেজিস্টার",
        "mobile_lbl": "মোবাইল নম্বর",
        "pass_lbl": "পাসৱর্ড",
        "conf_pass_lbl": "পাসৱর্ড কনফার্ম তৌবা",
        "lang_select": "লৈবাক পুম্বগী লোন খনবা",
        "mode_select": "ফার্ম সবিস খনবা",
        "mode_opt": "🌾 মালেম অমসুং সার অপ্টিমাইজেসন",
        "mode_diag": "🔬 পাম্বীগী লাইনা অমসুং হিদাক খক্তা",
        "btn_login": "কন্ত্রোল সেন্তরদা চঙশিনবা ➔",
        "btn_reg": "অ্যাকাউন্ট শাগৎপা",
        "btn_back": "⬅️ হঞ্জিনবা",
        "btn_next": "মখা চত্থবা ➔",
        "budget_lbl": "খ্বাইদগী থিবা সারের বাজেট (₹)",
        "budget_help": "চঙবা লুপা মখা অসিগী মনুংদা লৈহৌবা।",
        "feedback_title": "🌟 লৌমীশিংগী ফিডবেক অমসুং স্তার রেতিং",
        "feedback_submit": "ফিডবেক থারকপা অমসুং চৎথোকপা ➔",
        "land_calc_title": "📐 লমগী মতিক অমসুং বাজেট",
        "stage_1_period": "অহানবা তাংকাক: চেন্দুবা মতম (নুমিত্ৰ ০)",
        "stage_1_method": "কমপোস্ত অমসুং DAP অমসুং 1/3 MOP থাবা।",
        "stage_2_period": "অন ২য় তাংকাক: মরম চাউবা (২০ - ২৫ নুমিত)",
        "stage_2_method": "1/2 ইউরিআ অমসুং 1/3 MOP থাবা।",
        "stage_3_period": "অহুমশুবা তাংকাক: খুইবা (৪৫ - ৫৫ নুমিত)",
        "stage_3_method": "ইউরিআ মমাঙ থাবা।",
        "soil_detected": "লোম খোইবা ফংলে",
        "soil_not_detected": "ফংদ্রে"
    },
    "ਪੰਜਾਬੀ (Punjabi)": {
    ...
    "नेपाली (Nepali)": {
        "title": "स्मार्ट किसान | एग्रीटेक कन्ट्रोल सेन्टर",
        "subtitle": "प्रमाणित 4R पोषक तत्व व्यवस्थापन, वास्तविक माटो विश्लेषण र आधिकारिक प्रेस्क्रिप्सन",
        "login_tab": "साइन इन",
        "reg_tab": "दर्ता गर्नुहोस्",
        "mobile_lbl": "मोबाइल नम्बर",
        "pass_lbl": "पासवर्ड",
        "conf_pass_lbl": "पासवर्ड पुष्टि गर्नुहोस्",
        "lang_select": "विश्वव्यापी भाषा चयन",
        "mode_select": "कृषि सेवा छान्नुहोस्",
        "mode_opt": "🌾 पूर्ण माटो तथा मल अनुकूलन पाइपलाइन",
        "mode_diag": "🔬 केवल वनस्पति रोग, किरा तथा औषधि निदान",
        "btn_login": "कन्ट्रोल सेन्टर प्रवेश गर्नुहोस् ➔",
        "btn_reg": "खाता सिर्जना गर्नुहोस्",
        "btn_back": "⬅️ पछाडि",
        "btn_next": "जारी राख्नुहोस् ➔",
        "budget_lbl": "तपाईको अधिकतम मल बजेट (₹)",
        "budget_help": "कुल खरिद लागत यस सीमा भित्र रहने सुनिश्चित गर्दछ।",
        "feedback_title": "🌟 अनिवार्य किसान प्रतिक्रिया र तारा मूल्याङ्कन",
        "feedback_submit": "प्रतिक्रिया पेस गर्नुहोस् र बाहिर निस्कनुहोस् ➔",
        "land_calc_title": "📐 जग्गा इकाई चयन र बजेट म्याट्रिक्स",
        "stage_1_period": "चरण १: आधारभूत मल (रोपणको समयमा - दिन ०)",
        "stage_1_method": "कम्पोस्ट, डीएपी र १/३ पोटास ५-७ सेन्टिमिटर गहिराइमा राख्नुहोस्।",
        "stage_2_period": "चरण २: वानस्पतिक वृद्धि (२० - २५ दिन पछि)",
        "stage_2_method": "आधा युरिया र १/३ पोटास बोटको लाइनमा राख्नुहोस्।",
        "stage_3_period": "चरण ३: फूल फुल्ने समय (४५ - ५५ दिन पछि)",
        "stage_3_method": "बाँकी युरिया र अन्तिम पोटास हाल्नुहोस्। ठूलो वर्षामा नराख्नुहोस्।",
        "soil_detected": "माटो पत्ता लाग्यो",
        "soil_not_detected": "पत्ता लागेन"
    },
    "Español (Spanish)": {
